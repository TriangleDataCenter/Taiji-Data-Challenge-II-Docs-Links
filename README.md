...
Each dataset is stored in a separate HDF5 (.h5) file, which can be downloaded at [The Zenodo Page of TDC II](https://zenodo.org/records/15532090) (please make sure to download the latest version). For **Challenge 0 – 2**, a TDI-combined and downsampled version can be downloaded at [The Zenodo Page of TDC II-XYZ](https://zenodo.org/records/15469724). For the main challenges, a "training set" (parameters known) version is also provided to establish a rational difficulty progression. The training set data, as well as the codes and models which are helpful for the analysis can be downloaded at [The Zenodo Page of TDC II Training Set](https://zenodo.org/records/17538642). Please take a moment to read the manual therein. The GitHub repository for TDC II training set can be accessed  at [TDC II training set repo].(https://github.com/TriangleDataCenter/TDCII_Training_Sets).
